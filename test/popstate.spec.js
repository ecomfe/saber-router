/**
 * @file popstate controller test spec
...
define(function (require) {
    ...
    var controller = require('saber-router/controller/popstate');

    describe('Popstate Controller', function () {
        ...
        describe('init/dipose', function () {
            ...
            it('should apply handler with current path', function (done) {
                ...
                var url = args[0];
                expect(url.toString()).toEqual('/test/runner.html?name=treelite&w=1');
                expect(url.path.get()).toEqual('/test/runner.html');
        ...
        describe('redirect', function () {
            ...
            it('do not change the hash while call it with `silent` param', function (done) {
                ...
                setTimeout(function () {
                    expect(handler.calls.count()).toBe(1);
                    expect(location.pathname).toEqual('/test/runner.html');
                    done();
                }, INTERVAL_TIME);
            });
